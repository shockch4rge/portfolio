...
long to complete one. I'd always thought about making my own blog. In this post, I'll go over the difficulties making one that suited
my taste,

## The Predecessors

This site is not the first edition that came about.
A few years ago, as someone who already built multiple webapps with React and was well-settled into it,
I decided to use it for my portfolio. But that version was pretty badly implemented because I didn't consider some of the issues with
building portfolio as a SPA.

Some of these things were:

1. Blog population - how was I going to write my blog posts? I did not wish to write HTML for everything....
2.
